...
[![Module Date](https://img.shields.io/badge/Module_Date-20210107-blue.svg)]()  
...
- __HostingGuard__ ([Dokumentation](HostingGuard))  
	Dieses Modul überwacht verschiedene Parameter von hosting.de Servern (Web Spaces, Databases).

- __WebSpaces__ ([Dokumentation](WebSpaces))  
  	Dieses Modul überwacht die hosting.de WebSpaces.